...
class ComprobanteController extends Controller
{
        ...
        // ejemplo
        // public function codificar(PdfComprobanteGenerar $PdfComprobanteGenerar)
        // {
        //     $base64 = $PdfComprobanteGenerar->encodeToBase64('pdfs/archivo.pdf');
        //     // lo que necesites hacer con el resultado
        // }

        public function imprimir($comprobante_id , $formato = 'Ticket')
        {
            $PdfComprobanteGenerar = new PdfComprobanteGenerar();
            return $PdfComprobanteGenerar->imprimir($comprobante_id, $formato);
        }


        // SOLO PARA TESTING
        public function obtenerPdfBase64($comprobante_id , $formato = 'Ticket')
        {
            $PdfComprobanteGenerar = new PdfComprobanteGenerar();
            return $PdfComprobanteGenerar->obtenerPdfBase64($comprobante_id, $formato);
        }
    ...
    //     $info = $this->generarInfoPdf($empresa, $comprobante, $productos, $formato);
    ...
    // private function generarInfoPdf($empresa, $comprobante, $productos, $formato) {
    //     $totalRevisado = floatval(($comprobante[0]->total) > 0 ? $comprobante[0]->total : ($comprobante[0]->total * -1)); 
