                ...
                <tbody>
                    @forelse ($comandas as $c)
                        <tr>
                            ...
                            <td x-bind:style="estadoColors['{{ $c->estado }}']">

                                    {{ $c->mesa->comentario ?? 'Sin comentarios' }}
                            </td>
                            ...
                            <td>
                                <a role="button" wire:click="cambioEstado({{ $c->id }})" href="{{route('imprimirComanda',['comanda'=>$c->id])}}" target="_blank" rel="noopener noreferrer">
