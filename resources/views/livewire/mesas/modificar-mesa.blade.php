<div>
            ...
            <div class="grid">
                ...
                <div class="col">
                    @if ($data)
                        ...
                        <a role="button" href="{{route('imprimirMesa',['mesa'=>$mesa->id])}}" target="_blank" rel="noopener noreferrer">
                        ...
                        <button wire:click="finalizarMesa" wire:confirm="Finalizar Mesa??">Finalizar</button>
                        <button wire:click="cancelarMesa" wire:confirm="Cancelar Mesa??" style="background-color: rgb(145, 62, 62);">Cancelar</button>
                    @endif
                </div>
            </div>
    ...
    <div class="container">
        ...
        <article>
            ...
            <livewire:mesas.carousel-botones :$rubros>


            {{-- <div class="grid">

                {{-- <div class="col">
                    <button>Cerbezas</button>
                </div>
                <div class="col">
                ...
                {{-- <button style="background-color: rgb(2, 154, 232);">Cerbeza</button>
                <button style="background-color: rgb(2, 154, 232);">Principal</button>
                <button style="background-color: rgb(2, 154, 232);">Postre</button>
                <button style="background-color: rgb(2, 154, 232);">Otros</button>
                <button style="background-color: rgb(2, 154, 232);">Otros</button>
                <button style="background-color: rgb(2, 154, 232);">Cerbeza</button>
                <button style="background-color: rgb(2, 154, 232);">Principal</button>
                <button style="background-color: rgb(2, 154, 232);">Postre</button> --}}
    ...
    <dialog {{$estadoModalEdicion}} >
        ...
        <dialog {{ $modificarDataModal ? 'open' : '' }}>
            <article>
                <h3>Modificar Pedido Mesa</h3>
        
                <fieldset>
                    <label>
                        Detalle
                        <input type="text" wire:model="modificarDetalle" wire:keydown.enter="modificarData">
                    </label>
                    <label>
                        Precio
                        <input type="number" wire:model="modificarPrecio" wire:keydown.enter="modificarData">
                    </label>
                    <label>
                        Cantidad
                        <input type="number" wire:model="modificarCantidad" wire:keydown.enter="modificarData"
                            @error('modificarCantidad')
                            aria-invalid="true"
                            aria-describedby="invalid-helper"
                            @enderror
                ...
                <footer>
                    <button class="secondary" wire:click="cerrarModalEdicionData">
                        Cancelar
                    </button>
                    <button wire:click="modificarData">Modificar</button>
                </footer>
            </article>
        </dialog>
